...
<head>
	...
	<script type="application/javascript" src="../controler/asesores.js"></script>
	...
	<div class="page-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!--<li class="nav-item">
							<?php 
								//$id = $_GET['id'];
								//echo '<a href="asesores.php?id='.$id.'" class="nav-link active">';
							?>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-copy"></i> <span>MI PERFIL</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="#" id="infoPersonal" onclick="PerfilAsesor()" class="nav-link">Información personal</a></li>
								<li class="nav-item"><a href="#" id="infoAsesorias" onclick="InfoAsesorias()" class="nav-link active">Información para asesorías</a></li>
								<li class="nav-item"><a href="#" id="infoPagos" onclick="InfoPagos()" class="nav-link">Información de pago</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="#" id="horario" onclick="Horario()" class="nav-link">Horario asignado</a></li>
								<li class="nav-item"><a href="#" id="restantes" onclick="Restantes()" class="nav-link active">Desglose de horas</a></li>
                                <li class="nav-item"><a href="#" id="estatus" onclick="EstatusAlumno()" class="nav-link">Ingresar comentarios</a></li>
                                <li class="nav-item"><a href="#" id="comentarios" onclick="RevisarComentarios()" class="nav-link">Revisar comentarios</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" id="historial" onclick="HistorialAsesorias()" class="nav-link"><i class="icon-copy"></i> <span>HISTORIAL DE ASESORIAS</span></a>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" id="contenido" onclick="ContenidoDisponible()" class="nav-link"><i class="icon-copy"></i> <span>CONTENIDO DISPONIBLE</span></a>
						</li>
					</ul>
				</div>
				<!-- /main navigation -->
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div id="campoAsesorias">
                    <div id="cuerpoAsesorias"></div>
                    <div id="cuerpoAsesorias2"></div>
                </div>
                <div id="campoPagos">
					<div id="cuerpoPagos"></div>
				</div>
				...
				<div id="campoRevisar">
					<div id="cuerpoRevisar"></div>
                </div>
                <div id="campoHistorial">
					<div id="cuerpoHistorial"></div>
                </div>
                <div id="campoContenidos">
					<div id="cuerpoContenidos"></div>
				</div>
